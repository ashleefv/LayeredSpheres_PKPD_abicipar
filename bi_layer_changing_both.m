...
hold on
box on
plot(time/(60*60*24), drug_dose, 'LineWidth', 2)
xlim([-2 200])
xlabel('Time (days)')
...
save("bi_layer_changing_both.mat","drug_release_profile","drug_release_time","VEGFdoseaq","VEGFdosev","Drugaq","Drugc","Drugr","Drugs","Drugv","Data_time_at_target_vit_10","Data_time_at_target_vit_50", "Data_time_at_target_aq_10", "Data_time_at_target_aq_50", "in_vivo_suppression_time","in_vitro_suppression_time")
